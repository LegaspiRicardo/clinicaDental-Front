    ...
    return (
        <div className=" justify-center mx-auto w-5/6 flex-col bg-white p-2">
            <div className="rounded-xl bg-white text-sm/7 text-gray-700 px-8 pt-8 pb-8">
                <h3 className="text-2xl font-bold mb-4">Editar Servicio</h3>
                ...
                <div className="flex ">
                    <div className=" w-full flex">
                        ...
                        <div className=" w-2/6 mx-auto">
                            <button className="bg-yellow-400 py-2 mt-7 rounded w-5/6 ml-8 text-black ">Actualizar</button>
                        </div>
                    </div>
                </div>
            </div>
